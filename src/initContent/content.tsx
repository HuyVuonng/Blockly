...
const INITIAL_TOOLBOX_JSON = {
  ...
  contents: [
    ...
    //     {
    //       kind: "block",
    //       blockxml: '<block type="change_background_color"></block>',
    //     },
    //   ],
    // },

    {
      ...
      contents: [
        ...
        {
          kind: "block",
          blockxml: '<block type="textinput"></block>',
        },
        {
          kind: "block",
          blockxml: '<block type="console_log"></block>',
        },
        {
          kind: "block",
          blockxml: '<block type="alert"></block>',
        },
        {
          kind: "block",
          blockxml: '<block type="start"></block>',
        },
      ],
    },
    {
      ...
      contents: [
        ...
        {
          kind: "block",
          blockxml: '<block type="ifblock"></block>',
        },
...

        {
          kind: "block",
          blockxml:
            '<block type="if_then"><field name="if">IF</field><field name="then">THEN</field></block>',
        },
        {
          kind: "block",
          blockxml:
...
const INITIAL_TOOLBOX_XML =
  ...
  '<category css-icon="customIcon fa fa-cog" kind="customlable" name="Color" colour="#66FF00">\n' +
  '<block type="change_background_color">\n' +
  "    </block>\n" +
  "</category>\n" +
